...
export default function Disclaimer() {
  return (
    <>
      ...
      <Jumbotron>
        <h1 className='display-3 text-center'>Disclaimer</h1>
      </Jumbotron>
      <Container className='min-vh-100 my-5 text-justify'>
        ...
        <p>
          The Firm will not be responsible for any damage suffered by users from
          ...
          or service interruptions as may occur because of any act/omission of
          parties. This disclaimer of liability also applies to any damages or
        ...
        <p>
          The Firm also makes it clear that it shall not be held liable for any
          damage/hurt/inconvenience caused to the User through the course of the
          provision of Services or as a result of the Users’ actions. The Firm
          makes no representations or warranties as to the conduct of the Users.
          The Firm takes no responsibility for any content that Users send or
          receive from other Users or Third-Party posts through the Website or
          Platform. Any material downloaded or otherwise obtained through use of
          the service is accessed at the Users own discretion and risk.
        </p>
        <p>
          ...
          Firm, and while certain information available on the Platform is the
          property of the Firm and the Firm endeavours to keep the said
          information updated and accurate, the Firm shall not make any
        ...
        <p>
          ...
          construed as imposing any liability, direct or indirect, on the Firm
          /Platform.
        </p>
        <p>
          The Firm shall disclaim all responsibility and owns no liability to
          ...
          event will the Firm be liable for any loss or damage including without
        ...
        <p>
          ...
          Platforms which are not under the control of the Firm or the Platform.
          ...
          the Firm takes no responsibility for, and will not be liable for, the
          Platform being temporarily unavailable due to technical issues beyond
          our control.
        </p>
        <p>
        ...
        <p>
          ...
          DAMAGE TO HIS/HER COMPUTER SYSTEMS OR LOSS OF DATA THAT RESULTS FROM
        ...
        <p>
          ...
          RESPECT TO THE THIRD-PARTY WEBSITE AND SERVICES ARE FOR INFORMATION
          PURPOSE ONLY.
        </p>
      </Container>
    </>
