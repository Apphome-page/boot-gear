...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <Jumbotron>
        <h1 className='display-3 text-center'>Privacy Policy</h1>
      </Jumbotron>
      <Container className='min-vh-100 my-5 text-justify'>
        ...
        <ol className='ml-5 text-left'>
          ...
          <li>
            ...
            personally identifiable information that the Platform may collect
            from User for the purpose of use of the platform or its facilities
            or such other purposes which is not limited and restricted to
            information such as Name, Email Id, Mobile number, Password, Photo
        ...
        <ol className='ml-5 text-left'>
          <li>Documents, Files, PDF, Excel Sheets etc.</li>
          <li>
        ...
        <p>
          ...
          not signed up on this Platform, including, but not limited to,
          browsing behaviour, pages viewed etc. We may also collect, and store
        ...
        <ol className='ml-5 text-left'>
          <li>
            To enable the provision of the platform features opted for/by you.
          </li>
        ...
        <p>
          ...
          service request may be shared with such third party. We may also do
        ...
        <p>
          ...
          service or feature on the Platform and opt-out of any non-essential
        ...
        <ol className='ml-5 text-left'>
          <li>For providing the service opted by you</li>
        ...
        <p>
          ...
          and make further services available to you.
        </p>
        <p>
        ...
        <p>
          ...
          scope of the consent of the individual concerned or as required by
        ...
        <p>
          ...
          websites or resources, which are provided by companies or persons
          other than Us. You acknowledge and agree that we are not responsible
          for the availability of any such external sites or resources, and do
          not endorse any advertising, services/products or other materials on
          ...
          sites or resources, or as a result of any reliance placed by you on
          the completeness, accuracy or existence of any advertising, products
          or other materials on, or available from, such websites or resources.
          These external websites and resource providers may have their own
        ...
        <p>
          ...
          a &quot;cookie&quot;. Cookies can also help us provide information
          which is targeted to your interests. Cookies may be used to identify
          logged in or registered users. Our Website uses session cookies to
          ensure that you have a good experience. These cookies contain a unique
          number, your &apos;session ID&apos;, which allows our server to
          recognize your computer and &apos;remember&apos; what you&apos;ve done
          on the site. The benefits of this are:
        </p>
        <ol className='ml-5 text-left'>
          <li>
            You only need to log in once if you&apos;re navigating secure areas
            of the site.
          </li>
          <li>
        ...
        <p>
          ...
          settings if you prefer. This may prevent you from taking full
          advantage of the Website. We also use various third-party cookies for
          usage, behavioural, analytics and preferences data. The following are
          the different types of cookies used on the Website:
        </p>
        <ol className='ml-5 text-left'>
          <li>
            <b>Authentication cookies</b>: To identify the user and share the
            content that he or she requested.
          </li>
          <li>
            <b>Functionality cookies</b>: For the customized user experience and
            resuming past course progress.
          </li>
          <li>
            <b>Tracking, optimization, and targeting cookies</b>: To capture
        ...
        <p>
          ...
          is regarded as confidential and therefore will not be divulged to any
        ...
        <p>
          ...
          private. We do however assure you that any and all disclosure of your
        ...
        <ol className='ml-5 text-left'>
          <li>
            ...
            Platform. If you choose to use these optional services, and in the
        ...
        <p>
          ...
          signing out after using our services.
        </p>
        <p>
          You agree not to use the account, username, email address or password
          of another Member at any time or to disclose your password to any
          third party. You are responsible for all actions taken with your login
