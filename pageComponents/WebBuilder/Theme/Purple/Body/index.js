    ...
    <BodyWrap>
      ...
      >
        <div className='row'>
          ...
          <Feature className={styles.featureTwo} keyName='appFeature-2'>
      ...
      <div className='position-relative bg-white'>
        <hr
          className={classNames('m-0', styles.featureTwo, styles.footerBreak)}
        />
      </div>
      <div
        className={classNames(
        ...
        <div className='container'>
          <div className='row pb-5'>
            ...
            <div id='container-contact' className='col-lg-3 my-1 py-1'>
              <h3>Contact Us</h3>
              <Contact className={styles.icon} keyName='appLinkLinkedin'>
                <svg
              ...
              <Contact className={styles.icon} keyName='appLinkFacebook'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkDiscord'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkTwitter'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkTwitch'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkWhatsapp'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkYoutube'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkInstagram'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkTelegram'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkPhone'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className={styles.icon} keyName='appLinkMail'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
