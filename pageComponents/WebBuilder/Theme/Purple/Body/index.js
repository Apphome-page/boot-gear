...
export default function Body({ children }) {
  ...
  return (
    <BodyWrap>
      ...
      <div
        className={classNames('position-relative', 'text-white', 'featureTwo')}
      >
        <div className='container'>
          <div className='row pb-5'>
            ...
            <div id='container-contact' className='col-lg-3 my-1 py-1'>
              <h3>Contact Us</h3>
              <Contact className='icon' keyName='appLinkLinkedin'>
                <svg
              ...
              <Contact className='icon' keyName='appLinkFacebook'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkDiscord'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkTwitter'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkTwitch'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkWhatsapp'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkYoutube'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkInstagram'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkTelegram'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkPhone'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
              ...
              <Contact className='icon' keyName='appLinkMail'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
