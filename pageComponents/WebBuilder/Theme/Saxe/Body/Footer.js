...
export default function Footer({ links = true }) {
  return (
    <div className='position-relative text-white extro'>
      <div className='extro-backdrop'>
        <div className='extro-backdrop-0' />
        <div className='extro-backdrop-1' />
        <div className='extro-backdrop-2' />
        <div className='extro-backdrop-3' />
      </div>
      <div className='position-relative container'>
        <div className='row pb-5'>
          ...
          >
            <h3 className='mb-3 lead font-weight-bold'>About</h3>
            <TextEditor
              keyName='appAbout'
          ...
          >
            <h3 className='mb-3 lead font-weight-bold'>Links</h3>
          ...
          <div className='col-lg-3 my-1 py-1'>
            <h3 className='mb-3 lead font-weight-bold'>Address</h3>
            <TextEditor
              keyName='appAddress'
              placeholderText='Hendrerit placerat! Dapibus rhoncus eveniet, elit quasi. Sagittis diamlorem sed, mauris fuga officiis lacus maece- '
            />
          ...
          <div id='container-contact' className='col-lg-3 my-1 py-1'>
            <h3 className='mb-3 lead font-weight-bold'>Contact</h3>
            <Contact
              className='icon'
              keyName='appLinkLinkedin'
              keyTitle='Linkedin Link:'
            >
              <svg
            ...
            <Contact className='icon' keyName='appLinkMail' keyTitle='e-Mail:'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='currentColor'
        ...
        <div className='row border-top border-light pt-3 pb-5'>
